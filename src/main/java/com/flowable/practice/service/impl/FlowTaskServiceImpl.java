...
import com.flowable.practice.enums.FlowComment;
import com.flowable.practice.exception.CustomException;
import com.flowable.practice.factory.FlowServiceFactory;
import com.flowable.practice.flow.CustomProcessDiagramGenerator;
import com.flowable.practice.service.IFlowTaskService;
import com.flowable.practice.utils.FlowableUtils;
...
public class FlowTaskServiceImpl extends FlowServiceFactory implements IFlowTaskService {
    ...
    public String complete(FlowTaskVo taskVo) {
...
//            Long userId = SecurityUtils.getLoginUser().getUser().getUserId();
     ...
     */
    @Override
    public List<HistoricProcessInstance> myProcess(Integer pageNum, Integer pageSize) {
...
//            Task task = taskService.createTaskQuery().processInstanceId(hisIns.getId()).singleResult();
     ...
     */
    @Override
    public String stopProcess(FlowTaskVo flowTaskVo) {
...
//                        StringUtils.isBlank(flowTaskVo.getComment()) ? "取消申请" : flowTaskVo.getComment());
     ...
     */
    @Override
    public List<Task> todoList(Integer pageNum, Integer pageSize) {
        String userId = "SecurityUtils.getLoginUser().getUser().getUserId()";
...
//                .taskAssignee(userId.toString())
     ...
     */
    @Override
    public List<HistoricTaskInstance> finishedList(Integer pageNum, Integer pageSize) {
        String userId = "SecurityUtils.getLoginUser().getUser().getUserId()";
     ...
     */
    @Override
    public List<HistoricActivityInstance> flowRecord(String procInsId, String deployId) {
